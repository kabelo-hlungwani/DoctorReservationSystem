...
<body>
	    ...
	    <article>
				<?PHP
                  $query="SELECT patient.name as name,patient.surname as surname,patient.email as email,appointment.date as date,appointment.time as time,appointment.appoint_id as app_id,appointment.info as info,appointment.payment as payment 
                  FROM appointment,patient 
                  where patient.patient_id=appointment.patient_id 
                  and appointment.doctor_id='$staffno'";
                  $result=mysqli_query($conn,$query);
                  $rows=mysqli_num_rows($result);
                  ...
                  ?>
                    ...
                    <th><p style="color: white;"><a class="button button-reversed" href="del.php?edt=<?php echo $rows['app_id'];?>" >Remove</a></p></th>
                    <br>
                    <th><p style="color: white;"><a class="button button-reversed" href="edit.php?edt=<?php echo $rows['app_id'];?>" >Reschedule</a></p></th>
                   </tr>
                     <?php
