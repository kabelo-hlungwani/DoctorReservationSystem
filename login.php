			...
			<aside id="sidebar" class="column-left">
				<ul>
                	<li>
                        ...
                        <ul class="blocklist">
                            <li><a href="index.php">Home</a></li>
                            <li class="selected-item"><a href="login.php">Patient Sign In</a></li>
...
if(document.forms["form"]["email"].value=="" && document.forms["form"]["pwd"].value=="")
{

uerror.innerHTML="<span style='color:red;''>"+" username or email required *</span>"
...
}else if(document.forms["form"]["pwd"].value=="")
{
...
return false;
				...
				<form action="login.php"  name="form" onsubmit="return validateForm();" method="post">
                    
                    <p><label for="email">Email:</label>
                    <input name="email" id="email" value="<?php echo $email;?>" type="email" /><span class="error" id="uerror"><?php echo $emailErr;?></span></p>
                    
                    <p><label for="name">Password:</label>
                    <input name="pwd" id="pwd" value="<?php echo $pwd;?>" type="Password" /><span class="error" id="perror"><?php echo $erpwd;?></span></p>
